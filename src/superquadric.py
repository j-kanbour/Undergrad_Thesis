...
class Superquadric:
    def __init__(self, object_ID, class_name, raw_data_1,  bbox=None, raw_depth=None, raw_mask=None, camera_info=None):
        ...
        self.pcd = PointCloudData(object_ID, raw_data_1, bbox, raw_depth, raw_mask, camera_info)
    ...
    def estimateE(self):
        ...
        try:
            ...
            """
                TODO: find better method, speed and accuracy
            """
    ...
    def defineE(self):
        """
            ...
            these definitions fail to complete full shapes
